...
NORMAL_CFLAGS := -I. -Iasn1c/skeletons \
		-D ENABLE_ENCLAVE_ASNONE_CODE=0 \
		-Wall -Wextra -fPIC $(CFLAGS)
SECURE_CFLAGS := -I. -Iasn1c/skeletons -Ilinux -Isgx \
...
ASN_MODULE_SOURCES := $(wildcard asn1c/skeletons/*.c)
ASN_MODULE_HEADERS := $(wildcard asn1c/skeletons/*.h)
...
generate:
	$(ASN1C) -R -S asn1c/skeletons *.asn1

# Check schemas
validate:
	$(ASN1C) -EF -S asn1c/skeletons *.asn1
